...
class TestActivation : public ::testing::Test
{
  public:
    ...
    {
        return activation->getExtVersionInfo(extVersion);
    }
...
TEST_F(TestActivation, getExtVersionInfo)
{
    std::string extVersion = "";
    auto ret = getExtVersionInfo(extVersion);
    EXPECT_TRUE(ret.empty());

    extVersion = TestActivation::extVersion;
    ret = getExtVersionInfo(extVersion);
